    ...
    */
    ...
    async function loadVacationLogs() {
        const { data } = await supabase
            ...
            .lte('created_at', new Date(VACANZA_END).toISOString())
    ...
    async function loadVacationPeaks() {
        const { data } = await supabase
            ...
            .lte('peak_time', new Date(VACANZA_END).toISOString())
